<?
/*
 * Test complex expressions for function default values.
 *
 ...
 * extension introduced by the PH7.
 */
function test($a = (function($a,$b,$c){ return $a+$b+$c; })(14,10+2,15),$v = "Time: "__TIME__, $c = "Date: ".__DATE__)
{
	echo $a.PHP_EOL;
	echo $v.PHP_EOL;
	echo $c.PHP_EOL;
